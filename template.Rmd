...
ggplot(violencedata)+
  geom_histogram(mapping=aes(x=LAWDOMVIOL))+
...
ggplot(violencedata, aes(x = LAWDOMVIOL, y = ATTITUDEVIOL, color=Region)) +
...
ggplot(violencedata, aes(ATTITUDEVIOL, after_stat(density), colour = IncomeGroup)) +
