...
ggsave("dependent_var_analysis.png")
```
...
ggsave("ind_var_histogram.png", width=20,height=16, units="cm")
```
...
corrplot(corr_matrix, method="color", tl.col="black", tl.srt=45, type="upper", p.mat=p.mat, sig.level = 0.05, addCoef.col = "black", diag=FALSE, insig = "blank", tl.cex=1.75, number.font=7, number.cex=1.75 )
```
